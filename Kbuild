ccflags-y += -Idrivers/staging/prima/
...
# Silence Unused Function And Missing Declaration Warnings After Major Removals
EXTRA_CFLAGS += $(call cc-disable-warning, unused-function)
EXTRA_CFLAGS += $(call cc-disable-warning, missing-declarations)
EXTRA_CFLAGS += -g0 -ffunction-sections -fdata-sections
